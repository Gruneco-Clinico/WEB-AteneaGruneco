            ...
            if "antecedentes" in self.examen.nombre.lower():
                try:
                    ...
                    if antecedentes_link and antecedentes_link.antecedentes_result:
                        ...
                        print(f"✅ Antecedentes encontrado: {self._resultado_cache}")

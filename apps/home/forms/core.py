...
class AnamnesisForm(forms.Form):
    ...
    quejas_sueno = forms.CharField(
        widget=forms.Textarea(
            attrs={
                "class": "form-control",
                "rows": 3,
                "placeholder": "Describe las quejas del sueño",
            }
        ),
    ...
    dificultad_conciliacion = forms.ChoiceField(
        ...
        label="Dificultad de conciliación",
    )
    dificultad_mantenimiento = forms.ChoiceField(
        choices=OPCIONES_SI_NO,
        widget=forms.RadioSelect,
        label="Dificultad de mantenimiento",
    )
    ...
    inicio = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Fecha de inicio"}
        ),
        required=False,
        label="Inicio",
    )
    ...
    frecuencia_semana = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Frecuencia semanal"}
        ),
        required=False,
    ...
    gravedad = forms.CharField(
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Gravedad"}
        ),
        required=False,
        label="Gravedad",
    )
    ...
    causa_conocida = forms.ChoiceField(
        choices=OPCIONES_SI_NO,
        widget=forms.RadioSelect,
        label="¿Existe una causa conocida?",
    )
    causa_cual = forms.CharField(
        widget=forms.Textarea(
            attrs={
                "class": "form-control",
                "rows": 2,
                "placeholder": "Si la respuesta es sí, describe la causa",
            }
        ),
        required=False,
        label="¿Cuál?",

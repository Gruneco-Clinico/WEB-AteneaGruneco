...
urlpatterns = [
    ...
    # Exámenes
    path("examen/resultado/<int:visita_examen_id>/",views.ver_resultado_examen,name="ver_resultado_examen",),
    path("realizar_examen/<int:visita_id>/<int:examen_id>/<int:paciente_id>/",views.realizar_examen,name="realizar_examen",),

    path("examen_sueno_fisico/",views.guardar_examen_fisico_sueno,name="guardar_examen_sueno_fisico",),
    path("guardar_sueno_anamnesis/",views.guardar_sueno_anamnesis,name="guardar_examen_anamnesis",),
    path("guardar_atenas/", views.guardar_atenas, name="guardar_atenas"),
    path("guardar_berlin/", views.guardar_berlin, name="guardar_berlin"),
    path("guardar_examen_Epworth/",views.guardar_examen_Epworth,name="guardar_examen_Epworth",),
